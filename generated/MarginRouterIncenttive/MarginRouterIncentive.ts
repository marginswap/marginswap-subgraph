...
export class MarginRouterIncentive extends ethereum.SmartContract {
  static bind(address: Address): MarginRouterIncentive {
    return new MarginRouterIncentive("MarginRouter", address);
  }
}
